...
IJK_LIB_UPSTREAM=https://github.91chi.fun/https://github.com/haoliweimiao/android-ndk-profiler.git
IJK_LIB_FORK=https://github.91chi.fun/https://github.com/haoliweimiao/android-ndk-profiler.git

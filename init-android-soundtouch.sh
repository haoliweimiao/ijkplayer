...
IJK_SOUNDTOUCH_UPSTREAM=https://github.com/haoliweimiao/IJKPlayer-soundtouch.git
IJK_SOUNDTOUCH_FORK=https://github.com/haoliweimiao/IJKPlayer-soundtouch.git
